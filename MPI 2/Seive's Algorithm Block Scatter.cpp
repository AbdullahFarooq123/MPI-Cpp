...
//	int* my_Array = new int[numbers_for_each_process];
//	MPI_Scatter(numbers_array, numbers_for_each_process, MPI_INT, my_Array, numbers_for_each_process, MPI_INT, 0, MPI_COMM_WORLD);
...
//		mark_and_broadcast(numbers_for_each_process, marked_array, no_of_processes, my_Array, my_rank, my_rank);
...
//		odd_array = get_odd(marked_array, my_Array, odd_length, numbers_for_each_process);
...
//			//Mark its divident
//			mark_divident(divisor, my_Array, marked_array, numbers_for_each_process);
//		}
